    ...
    .then((data) => {
      ...
      var Objectarray = {
        ...
        Maryland: {
          ...
          set5: {
            url5:
              "https://api.census.gov/data/2019/acs/acs5/subject?get=NAME,C18120_007E&for=county:001&in=state:24&key=855666deab62d95596011f1944d9f1bd8c918853",
            arrayformat5: [
              "Maryland",
              "2019",
          ...
          set8: {
            url8:
              "https://api.census.gov/data/" +
              year +
              "/acs/acs5?get=NAME,C18120_008E&for=county:001&in=state:24&key=855666deab62d95596011f1944d9f1bd8c918853",
            arrayformat8: [
              "Maryland",
              year,
              "Employment Status By Disability Status",
