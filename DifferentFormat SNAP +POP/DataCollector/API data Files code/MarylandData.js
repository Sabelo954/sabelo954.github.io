...
var urlpop= "https://api.census.gov/data/2019/acs/acs5/subject?get=NAME,S1701_C02_027E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
  var dataIBPLLFbeg= data[1];
  var dataIBPLLF2019= dataIBPLLFbeg.map(Number).slice(1,2);
  console.log(dataIBPLLF2019);
...
d3.json(urlpop).get(function(error,data){
  var dataIBPLLFbeg= data[1];
  var dataIBPLLF2018= dataIBPLLFbeg.map(Number).slice(1,2);
  console.log(dataIBPLLF2018);

  var urlpop= "https://api.census.gov/data/2017/acs/acs5/subject?get=NAME,S1701_C02_027E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
  d3.json(urlpop).get(function(error,data){
    var dataIBPLLFbeg= data[1];
    var dataIBPLLF2017= dataIBPLLFbeg.map(Number).slice(1,2);
    console.log(dataIBPLLF2017);

    var urlpop= "https://api.census.gov/data/2016/acs/acs5/subject?get=NAME,S1701_C02_027E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
    d3.json(urlpop).get(function(error,data){
      var dataIBPLLFbeg= data[1];
      var dataIBPLLF2016= dataIBPLLFbeg.map(Number).slice(1,2);
      console.log(dataIBPLLF2016);

      var urlpop= "https://api.census.gov/data/2016/acs/acs5/subject?get=NAME,S1701_C02_027E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
      d3.json(urlpop).get(function(error,data){
        var dataIBPLLFbeg= data[1];
        var dataIBPLLF2015= dataIBPLLFbeg.map(Number).slice(1,2);
        console.log(dataIBPLLF2015);

        //Labor Force - With a disability

        //Labor Force - Without a disability





  //Employed - Income Below Poverty Level
  //All years

  var urlpop= "https://api.census.gov/data/2018/acs/acs5/subject?get=NAME,S1701_C02_028E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
  d3.json(urlpop).get(function(error,data){
    var dataIBPLEmbeg= data[1];
    var dataIBPLEm2019= dataIBPLEmbeg.map(Number).slice(1,2);
    console.log(dataIBPLEm2019);

  var urlpop= "https://api.census.gov/data/2018/acs/acs5/subject?get=NAME,S1701_C02_028E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
  d3.json(urlpop).get(function(error,data){
    var dataIBPLEmbeg= data[1];
    var dataIBPLEm2018= dataIBPLEmbeg.map(Number).slice(1,2);
    console.log(dataIBPLEm2018);

    var urlpop= "https://api.census.gov/data/2017/acs/acs5/subject?get=NAME,S1701_C02_028E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
    d3.json(urlpop).get(function(error,data){
      var dataIBPLEmbeg= data[1];
      var dataIBPLEm2017= dataIBPLEmbeg.map(Number).slice(1,2);
      console.log(dataIBPLEm2017);

      var urlpop= "https://api.census.gov/data/2016/acs/acs5/subject?get=NAME,S1701_C02_028E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
      d3.json(urlpop).get(function(error,data){
        var dataIBPLEmbeg= data[1];
        var dataIBPLEm2016= dataIBPLEmbeg.map(Number).slice(1,2);
        console.log(dataIBPLEm2016);

        var urlpop= "https://api.census.gov/data/2016/acs/acs5/subject?get=NAME,S1701_C02_028E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
        d3.json(urlpop).get(function(error,data){
          var dataIBPLEmbeg= data[1];
          var dataIBPLEm2015= dataIBPLEmbeg.map(Number).slice(1,2);
          console.log(dataIBPLEm2015);

// Unemployed - Income Below Poverty Level
//All years

var urlpop= "https://api.census.gov/data/2019/acs/acs5/subject?get=NAME,S1701_C02_031E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
  var dataIBPLUnembeg= data[1];
  var dataIBPLUnem2019= dataIBPLUnembeg.map(Number).slice(1,2);
  console.log(dataIBPLUnem2019);

var urlpop= "https://api.census.gov/data/2018/acs/acs5/subject?get=NAME,S1701_C02_031E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
  var dataIBPLUnembeg= data[1];
  var dataIBPLUnem2018= dataIBPLUnembeg.map(Number).slice(1,2);
  console.log(dataIBPLUnem2018);

  var urlpop= "https://api.census.gov/data/2017/acs/acs5/subject?get=NAME,S1701_C02_031E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
  d3.json(urlpop).get(function(error,data){
    var dataIBPLUnembeg= data[1];
    var dataIBPLUnem2017= dataIBPLUnembeg.map(Number).slice(1,2);
    console.log(dataIBPLUnem2017);

    var urlpop= "https://api.census.gov/data/2016/acs/acs5/subject?get=NAME,S1701_C02_031E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
    d3.json(urlpop).get(function(error,data){
      var dataIBPLUnembeg= data[1];
      var dataIBPLUnem2016= dataIBPLUnembeg.map(Number).slice(1,2);
      console.log(dataIBPLUnem2016);

      var urlpop= "https://api.census.gov/data/2016/acs/acs5/subject?get=NAME,S1701_C02_031E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
      d3.json(urlpop).get(function(error,data){
        var dataIBPLUnembeg= data[1];
        var dataIBPLUnem2015= dataIBPLUnembeg.map(Number).slice(1,2);
        console.log(dataIBPLUnem2015);

// Without disability
// Without disability- Employed
var urlpop= "https://api.census.gov/data/2019/acs/acs5?get=NAME,C18120_005E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
  var dataWDisembeg= data[1];
  var dataWDisem2019= dataWDisembeg.map(Number).slice(1,2);
  console.log(dataWDisem2019);

var urlpop= "https://api.census.gov/data/2018/acs/acs5?get=NAME,C18120_005E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
  var dataWDisembeg= data[1];
  var dataWDisem2018= dataWDisembeg.map(Number).slice(1,2);
  console.log(dataWDisem2018);

  var urlpop= "https://api.census.gov/data/2017/acs/acs5?get=NAME,C18120_005E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
  d3.json(urlpop).get(function(error,data){
    var dataWDisembeg= data[1];
    var dataWDisem2017= dataWDisembeg.map(Number).slice(1,2);
    console.log(dataWDisem2017);

    var urlpop= "https://api.census.gov/data/2016/acs/acs5?get=NAME,C18120_005E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
    d3.json(urlpop).get(function(error,data){
      var dataWDisembeg= data[1];
      var dataWDisem2016= dataWDisembeg.map(Number).slice(1,2);
      console.log(dataWDisem2016);

      var urlpop= "https://api.census.gov/data/2016/acs/acs5?get=NAME,C18120_005E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
      d3.json(urlpop).get(function(error,data){
        var dataWDisembeg= data[1];
        var dataWDisem2015= dataWDisembeg.map(Number).slice(1,2);
        console.log(dataWDisem2015);
// Without disability- Unemployed

var urlpop= "https://api.census.gov/data/2019/acs/acs5?get=NAME,C18120_008E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
  var dataWDisUnembeg= data[1];
  var dataWDisUnem2019= dataWDisUnembeg.map(Number).slice(1,2);
  console.log(dataWDisUnem2019);

var urlpop= "https://api.census.gov/data/2018/acs/acs5?get=NAME,C18120_008E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
  var dataWDisUnembeg= data[1];
  var dataWDisUnem2018= dataWDisUnembeg.map(Number).slice(1,2);
  console.log(dataWDisUnem2018);

  var urlpop= "https://api.census.gov/data/2017/acs/acs5?get=NAME,C18120_008E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
  d3.json(urlpop).get(function(error,data){
    var dataWDisUnembeg= data[1];
    var dataWDisUnem2017= dataWDisUnembeg.map(Number).slice(1,2);
    console.log(dataWDisUnem2017);

    var urlpop= "https://api.census.gov/data/2016/acs/acs5?get=NAME,C18120_008E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
    d3.json(urlpop).get(function(error,data){
      var dataWDisUnembeg= data[1];
      var dataWDisUnem2016= dataWDisUnembeg.map(Number).slice(1,2);
      console.log(dataWDisUnem2016);

      var urlpop= "https://api.census.gov/data/2016/acs/acs5?get=NAME,C18120_008E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
      d3.json(urlpop).get(function(error,data){
        var dataWDisUnembeg= data[1];
        var dataWDisUnem2015= dataWDisUnembeg.map(Number).slice(1,2);
        console.log(dataWDisUnem2015);

// Without disability- LaborForce ~ add Employed and unemployed

// Disability
// Disability- Employed

var urlpop= "https://api.census.gov/data/2019/acs/acs5?get=NAME,C18120_004E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
  var dataDisembeg= data[1];
  var dataDisem2019= dataDisembeg.map(Number).slice(1,2);
  console.log(dataDisem2019);

var urlpop= "https://api.census.gov/data/2018/acs/acs5?get=NAME,C18120_004E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
  var dataDisembeg= data[1];
  var dataDisem2018= dataDisembeg.map(Number).slice(1,2);
  console.log(dataDisem2018);

  var urlpop= "https://api.census.gov/data/2017/acs/acs5?get=NAME,C18120_004E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
  d3.json(urlpop).get(function(error,data){
    var dataDisembeg= data[1];
    var dataDisem2017= dataDisembeg.map(Number).slice(1,2);
    console.log(dataDisem2017);

    var urlpop= "https://api.census.gov/data/2016/acs/acs5?get=NAME,C18120_004E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
    d3.json(urlpop).get(function(error,data){
      var dataDisembeg= data[1];
      var dataDisem2016= dataDisembeg.map(Number).slice(1,2);
      console.log(dataDisem2016);

      var urlpop= "https://api.census.gov/data/2016/acs/acs5?get=NAME,C18120_004E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
      d3.json(urlpop).get(function(error,data){
        var dataDisembeg= data[1];
        var dataDisem2015= dataDisembeg.map(Number).slice(1,2);
        console.log(dataDisem2015);
// Disability- Unemployed

var urlpop= "https://api.census.gov/data/2019/acs/acs5?get=NAME,C18120_007E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
  var dataDisUnembeg= data[1];
  var dataDisUnem2019= dataDisUnembeg.map(Number).slice(1,2);
  console.log(dataDisUnem2019);

var urlpop= "https://api.census.gov/data/2018/acs/acs5?get=NAME,C18120_007E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
  var dataDisUnembeg= data[1];
  var dataDisUnem2018= dataDisUnembeg.map(Number).slice(1,2);
  console.log(dataDisUnem2018);

  var urlpop= "https://api.census.gov/data/2017/acs/acs5?get=NAME,C18120_007E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
  d3.json(urlpop).get(function(error,data){
    var dataDisUnembeg= data[1];
    var dataDisUnem2017= dataDisUnembeg.map(Number).slice(1,2);
    console.log(dataDisUnem2017);

    var urlpop= "https://api.census.gov/data/2016/acs/acs5?get=NAME,C18120_007E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
    d3.json(urlpop).get(function(error,data){
      var dataDisUnembeg= data[1];
      var dataDisUnem2016= dataDisUnembeg.map(Number).slice(1,2);
      console.log(dataDisUnem2016);

      var urlpop= "https://api.census.gov/data/2015/acs/acs5?get=NAME,C18120_007E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
      d3.json(urlpop).get(function(error,data){
        var dataDisUnembeg= data[1];
        var dataDisUnem2015= dataDisUnembeg.map(Number).slice(1,2);
        console.log(dataDisUnem2015);
...
//Median Household Income
                  ...
                  d3.json(urlMedianHincome).get(function(error,data){
                    ...
                    var urlMedianHincome= "https://api.census.gov/data/2018/acs/acs1/subject?get=NAME,S1901_C01_012E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
                    d3.json(urlMedianHincome).get(function(error,data){
                      var dataMedianHincomebeg= data[1];
                      var dataMedianHincome2018= dataMedianHincomebeg.map(Number).slice(1,2);
                      console.log(dataMedianHincome2018);

                      var urlMedianHincome= "https://api.census.gov/data/2017/acs/acs1/subject?get=NAME,S1901_C01_012E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
                      d3.json(urlMedianHincome).get(function(error,data){
                        var dataMedianHincomebeg= data[1];
                        var dataMedianHincome2017= dataMedianHincomebeg.map(Number).slice(1,2);
                        console.log(dataMedianHincome2017);

                        var urlMedianHincome= "https://api.census.gov/data/2016/acs/acs1/subject?get=NAME,S1901_C01_012E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
                        d3.json(urlMedianHincome).get(function(error,data){
                          var dataMedianHincomebeg= data[1];
...
var urlpop= "https://api.census.gov/data/2019/acs/acs5/subject?get=NAME,S2301_C04_022E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
  var dataUnempMalebeg= data[1];
  var dataUnempMale2019= dataUnempMalebeg.map(Number).slice(1,2);
  console.log(dataUnempMale2019);

                            var urlpop= "https://api.census.gov/data/2018/acs/acs5/subject?get=NAME,S2301_C04_022E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
                            d3.json(urlpop).get(function(error,data){
                              var dataUnempMalebeg= data[1];
                              var dataUnempMale2018= dataUnempMalebeg.map(Number).slice(1,2);
                              console.log(dataUnempMale2018);

                              var urlpop= "https://api.census.gov/data/2017/acs/acs5/subject?get=NAME,S2301_C04_022E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
                              d3.json(urlpop).get(function(error,data){
                                var dataUnempMalebeg= data[1];
                                var dataUnempMale2017= dataUnempMalebeg.map(Number).slice(1,2);
                                console.log(dataUnempMale2017);

                                var urlpop= "https://api.census.gov/data/2016/acs/acs5/subject?get=NAME,S2301_C04_022E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
                                d3.json(urlpop).get(function(error,data){
                                  var dataUnempMalebeg= data[1];
                                  var dataUnempMale2016= dataUnempMalebeg.map(Number).slice(1,2);
                                  console.log(dataUnempMale2016);

                                  var urlpop= "https://api.census.gov/data/2015/acs/acs5/subject?get=NAME,S2301_C04_022E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
                                  d3.json(urlpop).get(function(error,data){
                                    var dataUnempMalebeg= data[1];
                                    var dataUnempMale2015= dataUnempMalebeg.map(Number).slice(1,2);
                                    console.log(dataUnempMale2015);

//  Female Unemployment rate
  var urlpop= "https://api.census.gov/data/2019/acs/acs5/subject?get=NAME,S2301_C04_023E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
      d3.json(urlpop).get(function(error,data){
      var dataUnempFemalebeg= data[1];
      var dataUnempFemale2019= dataUnempFemalebeg.map(Number).slice(1,2);
      console.log(dataUnempFemale2019);

      var urlpop= "https://api.census.gov/data/2018/acs/acs5/subject?get=NAME,S2301_C04_023E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
      d3.json(urlpop).get(function(error,data){
      var dataUnempFemalebeg= data[1];
      var dataUnempFemale2018= dataUnempFemalebeg.map(Number).slice(1,2);
      console.log(dataUnempFemale2018);

      var urlpop= "https://api.census.gov/data/2017/acs/acs5/subject?get=NAME,S2301_C04_023E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
       d3.json(urlpop).get(function(error,data){
       var dataUnempFemalebeg= data[1];
       var dataUnempFemale2017= dataUnempFemalebeg.map(Number).slice(1,2);
       console.log(dataUnempFemale2017);

       var urlpop= "https://api.census.gov/data/2016/acs/acs5/subject?get=NAME,S2301_C04_023E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
        d3.json(urlpop).get(function(error,data){
        var dataUnempFemalebeg= data[1];
        var dataUnempFemale2016= dataUnempFemalebeg.map(Number).slice(1,2);
        console.log(dataUnempFemale2016);

        var urlpop= "https://api.census.gov/data/2015/acs/acs5/subject?get=NAME,S2301_C04_023E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
        d3.json(urlpop).get(function(error,data){
        var dataUnempFemalebeg= data[1];
        var dataUnempFemale2015= dataUnempFemalebeg.map(Number).slice(1,2);
        console.log(dataUnempFemale2015);

//ACS- less high school graduate- employed

var urlpop= "https://api.census.gov/data/2015/acs/acs5/subject?get=NAME,S2301_C04_023E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataLHSembeg= data[1];
var dataLHSem2015= dataLHSembeg.map(Number).slice(1,2);
console.log(dataLHSem2015);

var urlpop= "https://api.census.gov/data/2016/acs/acs5/subject?get=NAME,S2301_C04_023E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataLHSembeg= data[1];
var dataLHSem2016= dataLHSembeg.map(Number).slice(1,2);
console.log(dataLHSem2016);

var urlpop= "https://api.census.gov/data/2017/acs/acs5/subject?get=NAME,S2301_C04_023E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataLHSembeg= data[1];
var dataLHSem2017= dataLHSembeg.map(Number).slice(1,2);
console.log(dataLHSem2017);

var urlpop= "https://api.census.gov/data/2018/acs/acs5/subject?get=NAME,S2301_C04_023E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataLHSembeg= data[1];
var dataLHSem2018= dataLHSembeg.map(Number).slice(1,2);
console.log(dataLHSem2018);

var urlpop= "https://api.census.gov/data/2019/acs/acs5/subject?get=NAME,S2301_C04_023E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataLHSembeg= data[1];
var dataLHSem2019= dataLHSembeg.map(Number).slice(1,2);
console.log(dataLHSem2019);

//ACS- less high school graduate- Unemployed

var urlpop= "https://api.census.gov/data/2016/acs/acs5?get=NAME,B23006_007E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataLHSUnembeg= data[1];
var dataLHSUnem2015= dataLHSUnembeg.map(Number).slice(1,2);
console.log(dataLHSUnem2015);

var urlpop= "https://api.census.gov/data/2016/acs/acs5?get=NAME,B23006_007E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataLHSUnembeg= data[1];
var dataLHSUnem2016= dataLHSUnembeg.map(Number).slice(1,2);
console.log(dataLHSUnem2016);

var urlpop= "https://api.census.gov/data/2017/acs/acs5?get=NAME,B23006_007E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataLHSUnembeg= data[1];
var dataLHSUnem2017= dataLHSUnembeg.map(Number).slice(1,2);
console.log(dataLHSUnem2017);

var urlpop= "https://api.census.gov/data/2018/acs/acs5?get=NAME,B23006_007E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataLHSUnembeg= data[1];
var dataLHSUnem2018= dataLHSUnembeg.map(Number).slice(1,2);
console.log(dataLHSUnem2018);

var urlpop= "https://api.census.gov/data/2019/acs/acs5?get=NAME,B23006_007E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataLHSUnembeg= data[1];
var dataLHSUnem2019= dataLHSUnembeg.map(Number).slice(1,2);
console.log(dataLHSUnem2019);

//ACS- less high school graduate- NIL

var urlpop= "https://api.census.gov/data/2015/acs/acs5?get=NAME,B23006_008E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataLHSNILbeg= data[1];
var dataLHSNIL2015= dataLHSembeg.map(Number).slice(1,2);
console.log(dataLHSNIL2015);

var urlpop= "https://api.census.gov/data/2016/acs/acs5?get=NAME,B23006_008E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataLHSNILbeg= data[1];
var dataLHSNIL2016= dataLHSembeg.map(Number).slice(1,2);
console.log(dataLHSNIL2016);

var urlpop= "https://api.census.gov/data/2017/acs/acs5?get=NAME,B23006_008E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataLHSNILbeg= data[1];
var dataLHSNIL2017= dataLHSembeg.map(Number).slice(1,2);
console.log(dataLHSNIL2017);

var urlpop= "https://api.census.gov/data/2018/acs/acs5?get=NAME,B23006_008E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataLHSNILbeg= data[1];
var dataLHSNIL2018= dataLHSembeg.map(Number).slice(1,2);
console.log(dataLHSNIL2018);

var urlpop= "https://api.census.gov/data/2019/acs/acs5?get=NAME,B23006_008E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataLHSNILbeg= data[1];
var dataLHSNIL2019= dataLHSembeg.map(Number).slice(1,2);
console.log(dataLHSNIL2019);

//ACS- employed High School Equivalency

var urlpop= "https://api.census.gov/data/2015/acs/acs5?get=NAME,B23006_013E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataHSEembeg= data[1];
var dataHSEem2015= dataHSEembeg.map(Number).slice(1,2);
console.log(dataHSEem2015);

var urlpop= "https://api.census.gov/data/2016/acs/acs5?get=NAME,B23006_013E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataHSEembeg= data[1];
var dataHSEem2016= dataHSEembeg.map(Number).slice(1,2);
console.log(dataHSEem2016);

var urlpop= "https://api.census.gov/data/2017/acs/acs5?get=NAME,B23006_013E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataHSEembeg= data[1];
var dataHSEem2017= dataHSEembeg.map(Number).slice(1,2);
console.log(dataHSEem2017);

var urlpop= "https://api.census.gov/data/2018/acs/acs5?get=NAME,B23006_013E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataHSEembeg= data[1];
var dataHSEem2018= dataHSEembeg.map(Number).slice(1,2);
console.log(dataHSEem2018);

var urlpop= "https://api.census.gov/data/2019/acs/acs5?get=NAME,B23006_013E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataHSEembeg= data[1];
var dataHSEem2019= dataHSEembeg.map(Number).slice(1,2);
console.log(dataHSEem2019);

//ACS- Unemployed High School Equivalency

var urlpop= "https://api.census.gov/data/2015/acs/acs5?get=NAME,B23006_014E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataHSEUnembeg= data[1];
var dataHSEUnem2015= dataHSEUnembeg.map(Number).slice(1,2);
console.log(dataHSEUnem2015);

var urlpop= "https://api.census.gov/data/2016/acs/acs5?get=NAME,B23006_014E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataHSEUnembeg= data[1];
var dataHSEUnem2016= dataHSEUnembeg.map(Number).slice(1,2);
console.log(dataHSEUnem2016);

var urlpop= "https://api.census.gov/data/2017/acs/acs5?get=NAME,B23006_014E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataHSEUnembeg= data[1];
var dataHSEUnem2017= dataHSEUnembeg.map(Number).slice(1,2);
console.log(dataHSEUnem2017);

var urlpop= "https://api.census.gov/data/2018/acs/acs5?get=NAME,B23006_014E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataHSEUnembeg= data[1];
var dataHSEUnem2018= dataHSEUnembeg.map(Number).slice(1,2);
console.log(dataHSEUnem2018);

var urlpop= "https://api.census.gov/data/2019/acs/acs5?get=NAME,B23006_014E&for=state:24&key=855666deab62d95596011f1944d9f1bd8c918853";
d3.json(urlpop).get(function(error,data){
var dataHSEUnembeg= data[1];
var dataHSEUnem2019= dataHSEUnembeg.map(Number).slice(1,2);
console.log(dataHSEUnem2019);



// QWI explorer data - Number of Workers

console.log("Data download is complete, Ready to export to CSV");
...
var Results = [
  ...
  ["Maryland","2015","Employment Status By Poverty Status","Below Poverty"+",","Labor Force"+",",dataIBPLLF2015],
  ["Maryland","2015","Employment Status By Poverty Status","Below Poverty"+",","Unemployed"+",",dataIBPLUnem2015],
  ["Maryland","2015","Employment Status By Poverty Status","Below Poverty"+",","Employed"+",",dataIBPLEm2015],
  ["Maryland","2016","Employment Status By Poverty Status","Below Poverty"+",","Unemployed"+",",dataIBPLUnem2016],
  ["Maryland","2016","Employment Status By Poverty Status","Below Poverty"+",","Employed"+",",dataIBPLEm2016],
  ["Maryland","2016","Employment Status By Poverty Status","Below Poverty"+",","Labor Force"+",",dataIBPLLF2016],
  ["Maryland","2017","Employment Status By Poverty Status","Below Poverty"+",","Unemployed"+",",dataIBPLUnem2017],
  ["Maryland","2017","Employment Status By Poverty Status","Below Poverty"+",","Employed"+",",dataIBPLEm2017],
  ["Maryland","2017","Employment Status By Poverty Status","Below Poverty"+",","Labor Force"+",",dataIBPLLF2017],
  ["Maryland","2018","Employment Status By Poverty Status","Below Poverty"+",","Unemployed"+",",dataIBPLUnem2018],
  ["Maryland","2018","Employment Status By Poverty Status","Below Poverty"+",","Employed"+",",dataIBPLEm2018],
  ["Maryland","2018","Employment Status By Poverty Status","Below Poverty"+",","Labor Force"+",",dataIBPLLF2018],
  ["Maryland","2019","Employment Status By Poverty Status","Below Poverty"+",","Labor Force"+",",dataIBPLLF2019],
  ["Maryland","2019","Employment Status By Poverty Status","Below Poverty"+",","Unemployed"+",",dataIBPLUnem2019],
  ["Maryland","2019","Employment Status By Poverty Status","Below Poverty"+",","Employed"+",",dataIBPLEm2019],
  ["Maryland","2015","Total Population",",,,",dataPop2015],
  ["Maryland","2016","Total Population",",,,",dataPop2016],
  ["Maryland","2017","Total Population",",,,",dataPop2017],
  ["Maryland","2018","Total Population",",,,",dataPop2018],
  ["Maryland","2019","Total Population",",,,",dataPop2019],
  ["Maryland","Change","Total Population",",,,",dataPop2019-dataPop2015],
  ["Maryland","2015","Median Household Income",",,,",dataMedianHincome2015],
  ["Maryland","2016","Median Household Income",",,,",dataMedianHincome2016],
  ["Maryland","2017","Median Household Income",",,,",dataMedianHincome2017],
  ["Maryland","2018","Median Household Income",",,,",dataMedianHincome2018],
  ["Maryland","2019","Median Household Income",",,,",dataMedianHincome2019],
  ["Maryland","Change","Median Household Income",",,,",dataMedianHincome2019-dataMedianHincome2015],
  ["Maryland","2018","Unemployment By Gender","Male"+",,,",dataUnempMale2018,dataUnempMale2018/100],
  ["Maryland","2017","Unemployment By Gender","Male"+",,,",dataUnempMale2017,dataUnempMale2017/100],
  ["Maryland","2016","Unemployment By Gender","Male"+",,,",dataUnempMale2016,dataUnempMale2016/100],
  ["Maryland","2015","Unemployment By Gender","Male"+",,,",dataUnempMale2015,dataUnempMale2015/100],
  ["Maryland","2018","Unemployment By Gender","Female"+",,,",dataUnempFemale2018,dataUnempFemale2018/100],
  ["Maryland","2017","Unemployment By Gender","Female"+",,,",dataUnempFemale2017,dataUnempFemale2017/100],
  ["Maryland","2016","Unemployment By Gender","Female"+",,,",dataUnempFemale2016,dataUnempFemale2016/100],
  ["Maryland","2015","Unemployment By Gender","Female"+",,,",dataUnempFemale2015,dataUnempFemale2015/100],
  ["Maryland","2015","Employment Status By Disability Status","Non Disabled"+",","Unemployed"+",",dataWDisUnem2015],
  ["Maryland","2016","Employment Status By Disability Status","Non Disabled"+",","Unemployed"+",",dataWDisUnem2016],
  ["Maryland","2017","Employment Status By Disability Status","Non Disabled"+",","Unemployed"+",",dataWDisUnem2017],
  ["Maryland","2018","Employment Status By Disability Status","Non Disabled"+",","Unemployed"+",",dataWDisUnem2018],
  ["Maryland","2019","Employment Status By Disability Status","Non Disabled"+",","Unemployed"+",",dataWDisUnem2019],
  ["Maryland","2015","Employment Status By Disability Status","Non Disabled"+",","Employed"+",",dataWDisem2015],
  ["Maryland","2016","Employment Status By Disability Status","Non Disabled"+",","Employed"+",",dataWDisem2016],
  ["Maryland","2017","Employment Status By Disability Status","Non Disabled"+",","Employed"+",",dataWDisem2017],
  ["Maryland","2018","Employment Status By Disability Status","Non Disabled"+",","Employed"+",",dataWDisem2018],
  ["Maryland","2019","Employment Status By Disability Status","Non Disabled"+",","Employed"+",",dataWDisem2019],
  ["Maryland","2015","Employment Status By Disability Status","Non Disabled"+",","Labor Force"+",",dataWDisUnem2015+dataDisem2015],
  ["Maryland","2016","Employment Status By Disability Status","Non Disabled"+",","Labor Force"+",",dataWDisUnem2016+dataDisem2016],
  ["Maryland","2017","Employment Status By Disability Status","Non Disabled"+",","Labor Force"+",",dataWDisUnem2017+dataDisem2017],
  ["Maryland","2018","Employment Status By Disability Status","Non Disabled"+",","Labor Force"+",",dataWDisUnem2018+dataDisem2018],
  ["Maryland","2019","Employment Status By Disability Status","Non Disabled"+",","Labor Force"+",",dataWDisUnem2019+dataDisem2019],
  ["Maryland","2015","Employment Status By Disability Status","Disabled"+",","Employed"+",",dataDisem2015],
  ["Maryland","2016","Employment Status By Disability Status","Disabled"+",","Employed"+",",dataDisem2016],
  ["Maryland","2017","Employment Status By Disability Status","Disabled"+",","Employed"+",",dataDisem2017],
  ["Maryland","2018","Employment Status By Disability Status","Disabled"+",","Employed"+",",dataDisem2018],
  ["Maryland","2019","Employment Status By Disability Status","Disabled"+",","Employed"+",",dataDisem2019],
  ["Maryland","2015","Employment Status By Disability Status","Disabled"+",","Unemployed"+",",dataDisUnem2015],
  ["Maryland","2016","Employment Status By Disability Status","Disabled"+",","Unemployed"+",",dataDisUnem2016],
  ["Maryland","2017","Employment Status By Disability Status","Disabled"+",","Unemployed"+",",dataDisUnem2017],
  ["Maryland","2018","Employment Status By Disability Status","Disabled"+",","Unemployed"+",",dataDisUnem2018],
  ["Maryland","2019","Employment Status By Disability Status","Disabled"+",","Unemployed"+",",dataDisUnem2019],
  ["Maryland","2015","Employment Status By Disability Status","Disabled"+",","Labor Force"+",",dataDisem2015+dataDisem2015],
  ["Maryland","2016","Employment Status By Disability Status","Disabled"+",","Labor Force"+",",dataDisem2016+dataDisem2016],
  ["Maryland","2017","Employment Status By Disability Status","Disabled"+",","Labor Force"+",",dataDisem2017+dataDisem2017],
  ["Maryland","2018","Employment Status By Disability Status","Disabled"+",","Labor Force"+",",dataDisem2018+dataDisem2018],
  ["Maryland","2019","Employment Status By Disability Status","Disabled"+",","Labor Force"+",",dataDisem2019+dataDisem2019],
  ["Maryland","2015","Employment Status By Education","Less than Highschool"+",","Employed"+",",dataLHSem2015],
  ["Maryland","2016","Employment Status By Education","Less than Highschool"+",","Employed"+",",dataLHSem2016],
  ["Maryland","2017","Employment Status By Education","Less than Highschool"+",","Employed"+",",dataLHSem2017],
  ["Maryland","2018","Employment Status By Education","Less than Highschool"+",","Employed"+",",dataLHSem2018],
  ["Maryland","2019","Employment Status By Education","Less than Highschool"+",","Employed"+",",dataLHSem2019],
  ["Maryland","2015","Employment Status By Education","Less than Highschool"+",","Unemployed"+",",dataLHSUnem2015],
  ["Maryland","2016","Employment Status By Education","Less than Highschool"+",","Unemployed"+",",dataLHSUnem2016],
  ["Maryland","2017","Employment Status By Education","Less than Highschool"+",","Unemployed"+",",dataLHSUnem2017],
  ["Maryland","2018","Employment Status By Education","Less than Highschool"+",","Unemployed"+",",dataLHSUnem2018],
  ["Maryland","2019","Employment Status By Education","Less than Highschool"+",","Unemployed"+",",dataLHSUnem2019],
  ["Maryland","2015","Employment Status By Education","Less than Highschool"+",","NIL"+",",dataLHSNIL2015],
  ["Maryland","2016","Employment Status By Education","Less than Highschool"+",","NIL"+",",dataLHSNIL2016],
  ["Maryland","2017","Employment Status By Education","Less than Highschool"+",","NIL"+",",dataLHSNIL2017],
  ["Maryland","2018","Employment Status By Education","Less than Highschool"+",","NIL"+",",dataLHSNIL2018],
  ["Maryland","2019","Employment Status By Education","Less than Highschool"+",","NIL"+",",dataLHSNIL2019],
  ["Maryland","2015","Employment Status By Education","Highschool"+",","Employed"+",",dataHSEem2015],
  ["Maryland","2016","Employment Status By Education","Highschool"+",","Employed"+",",dataHSEem2016],
  ["Maryland","2017","Employment Status By Education","Highschool"+",","Employed"+",",dataHSEem2017],
  ["Maryland","2018","Employment Status By Education","Highschool"+",","Employed"+",",dataHSEem2018],
  ["Maryland","2019","Employment Status By Education","Highschool"+",","Employed"+",",dataHSEem2019],
  ["Maryland","2015","Employment Status By Education","Highschool"+",","Unemployed"+",",dataHSEUnem2015],
  ["Maryland","2016","Employment Status By Education","Highschool"+",","Unemployed"+",",dataHSEUnem2016],
  ["Maryland","2017","Employment Status By Education","Highschool"+",","Unemployed"+",",dataHSEUnem2017],
  ["Maryland","2018","Employment Status By Education","Highschool"+",","Unemployed"+",",dataHSEUnem2018],
  ["Maryland","2019","Employment Status By Education","Highschool"+",","Unemployed"+",",dataHSEUnem2019],
  ["Maryland","2019","Employment Status By Poverty Status","Above Poverty"+",","Unemployed"+",",118358],
  ["Maryland","2019","Employment Status By Poverty Status","Above Poverty"+",","Employed"+",",2952411],
  ["Maryland","2019","Employment Status By Poverty Status","Above Poverty"+",","Labor Force"+",",3070766],
  ...
  ["Maryland","2018","Employment Status By Poverty Status","Above Poverty"+",","Labor Force"+",",3070766],
  ...
  ["Maryland","2017","Employment Status By Poverty Status","Above Poverty"+",","Labor Force"+",",3053026],
  ["Maryland","2015","Employment Status By Poverty Status","Above Poverty"+",","Unemployed"+",",176062],
  ["Maryland","2015","Employment Status By Poverty Status","Above Poverty"+",","Employed"+",",2840466],
  ...
  ["Maryland","2016","Employment Status By Poverty Status","Above Poverty"+",","Unemployed"+",",160686],
  ...
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Age","56","Administrative and Support and Waste Management and Remediation Services"+",","Earnings",3789],
  ...
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","72","Accommodation and Food Services"+",","Earnings",1929],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","72","Accommodation and Food Services"+",","Earnings",1929],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","71","Arts, Entertainment, and Recreation"+",","Earnings",2478],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","71","Arts, Entertainment, and Recreation"+",","Earnings",2480],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","44-45","Retail Trade"+",","Earnings",2816],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","11","Agriculture, Forestry, Fishing and Hunting"+",","Earnings",3178],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","81","Other Services (except Public Administration)"+",","Earnings",3560],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","81","Other Services (except Public Administration)"+",","Earnings",3564],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","56","Administrative and Support and Waste Management and Remediation Services"+",","Earnings",3770],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","56","Administrative and Support and Waste Management and Remediation Services"+",","Earnings",3771],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","62","Health Care and Social Assistance"+",","Earnings",4268],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","62","Health Care and Social Assistance"+",","Earnings",4273],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","48-49","Transportation and Warehousing"+",","Earnings",4685],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","61","Educational Services"+",","Earnings",4764],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","61","Educational Services"+",","Earnings",4765],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","92","Public Administration"+",","Earnings",4870],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","92","Public Administration"+",","Earnings",4871],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","23","Construction"+",","Earnings",5306],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","53","Real Estate and Rental and Leasing"+",","Earnings",6176],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","53","Real Estate and Rental and Leasing"+",","Earnings",6195],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","21","Mining, Quarrying, and Oil and Gas Extraction",,"Earnings",6429],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","42","Wholesale Trade"+",","Earnings",6959],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","31-33","Manufacturing"+",","Earnings",7689],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","51","Information"+",","Earnings",8157],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","54","Professional, Scientific, and Technical Services",,"Earnings",8367],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","54","Professional, Scientific, and Technical Services",,"Earnings",8371],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","55","Management of Companies and Enterprises"+",","Earnings",10790],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","55","Management of Companies and Enterprises"+",","Earnings",10826],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","52","Finance and Insurance"+",","Earnings",10946],
  ["Maryland","2018Q1","Maryland Average Monthly Earnings by Industry","22","Utilities"+",","Earnings",13981],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","72","Accommodation and Food Services"+",","Earnings",1993],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","71","Arts, Entertainment, and Recreation"+",","Earnings",2467],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","44-45","Retail Trade"+",","Earnings",2861],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","11","Agriculture, Forestry, Fishing and Hunting"+",","Earnings",3525],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","81","Other Services (except Public Administration)"+",","Earnings",3654],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","56","Administrative and Support and Waste Management and Remediation Services"+",","Earnings",3789],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","48-49","Transportation and Warehousing"+",","Earnings",4422],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","62","Health Care and Social Assistance"+",","Earnings",4426],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","92","Public Administration"+",","Earnings",4831],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","61","Educational Services"+",","Earnings",5056],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","53","Real Estate and Rental and Leasing"+",","Earnings",5203],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","23","Construction"+",","Earnings",5350],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","21","Mining, Quarrying, and Oil and Gas Extraction",,"Earnings",6158],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","31-33","Manufacturing"+",","Earnings",6396],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","42","Wholesale Trade"+",","Earnings",6469],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","55","Management of Companies and Enterprises"+",","Earnings",7334],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","51","Information"+",","Earnings",7362],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","54","Professional, Scientific, and Technical Services",,"Earnings",7897],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","52","Finance and Insurance"+",","Earnings",8239],
  ["Maryland","2018Q2","Maryland Average Monthly Earnings by Industry","22","Utilities"+",","Earnings",8867],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","72","Accommodation and Food Services"+",","Earnings",2051],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","44-45","Retail Trade"+",","Earnings",2871],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","71","Arts, Entertainment, and Recreation"+",","Earnings",2890],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","11","Agriculture, Forestry, Fishing and Hunting"+",","Earnings",3262],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","81","Other Services (except Public Administration)"+",","Earnings",3722],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","56","Administrative and Support and Waste Management and Remediation Services"+",","Earnings",3737],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","48-49","Transportation and Warehousing"+",","Earnings",4373],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","62","Health Care and Social Assistance"+",","Earnings",4377],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","61","Educational Services"+",","Earnings",4386],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","92","Public Administration"+",","Earnings",4913],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","53","Real Estate and Rental and Leasing"+",","Earnings",5167],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","23","Construction"+",","Earnings",5358],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","31-33","Manufacturing"+",","Earnings",6181],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","21","Mining, Quarrying, and Oil and Gas Extraction",,"Earnings",6425],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","42","Wholesale Trade"+",","Earnings",6592],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","51","Information"+",","Earnings",6927],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","55","Management of Companies and Enterprises"+",","Earnings",7021],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","52","Finance and Insurance"+",","Earnings",7712],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","54","Professional, Scientific, and Technical Services",,"Earnings",7932],
  ["Maryland","2018Q3","Maryland Average Monthly Earnings by Industry","22","Utilities"+",","Earnings",8175],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","72","Accommodation and Food Services"+",","Earnings",2044],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","44-45","Retail Trade"+",","Earnings",2997],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","71","Arts, Entertainment, and Recreation"+",","Earnings",3289],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","11","Agriculture, Forestry, Fishing and Hunting"+",","Earnings",3674],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","81","Other Services (except Public Administration)"+",","Earnings",3856],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","56","Administrative and Support and Waste Management and Remediation Services"+",","Earnings",4030],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","48-49","Transportation and Warehousing"+",","Earnings",4694],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","62","Health Care and Social Assistance"+",","Earnings",4741],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","92","Public Administration"+",","Earnings",4942],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","61","Educational Services"+",","Earnings",5190],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","53","Real Estate and Rental and Leasing"+",","Earnings",5741],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","23","Construction"+",","Earnings",6008],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","21","Mining, Quarrying, and Oil and Gas Extraction",,"Earnings",6299],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","31-33","Manufacturing"+",","Earnings",6644],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","42","Wholesale Trade"+",","Earnings",6973],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","51","Information"+",","Earnings",7364],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","55","Management of Companies and Enterprises"+",","Earnings",8396],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","54","Professional, Scientific, and Technical Services",,"Earnings",8843],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","22","Utilities"+",","Earnings",9253],
  ["Maryland","2018Q4","Maryland Average Monthly Earnings by Industry","52","Finance and Insurance"+",","Earnings",10375],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","72","Accommodation and Food Services"+",","Earnings",1993],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","71","Arts, Entertainment, and Recreation"+",","Earnings",2424],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","44-45","Retail Trade"+",","Earnings",2875],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","11","Agriculture, Forestry, Fishing and Hunting"+",","Earnings",3357],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","81","Other Services (except Public Administration)"+",","Earnings",3662],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","56","Administrative and Support and Waste Management and Remediation Services"+",","Earnings",3829],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","62","Health Care and Social Assistance"+",","Earnings",4375],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","48-49","Transportation and Warehousing"+",","Earnings",4657],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","61","Educational Services"+",","Earnings",4828],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","92","Public Administration"+",","Earnings",4987],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","23","Construction"+",","Earnings",5351],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","53","Real Estate and Rental and Leasing"+",","Earnings",6239],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","21","Mining, Quarrying, and Oil and Gas Extraction",,"Earnings",6876],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","42","Wholesale Trade"+",","Earnings",7045],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","31-33","Manufacturing"+",","Earnings",7367],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","54","Professional, Scientific, and Technical Services",,"Earnings",8628],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","51","Information"+",","Earnings",8932],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","55","Management of Companies and Enterprises"+",","Earnings",10568],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","52","Finance and Insurance"+",","Earnings",11095],
  ["Maryland","2019Q1","Maryland Average Monthly Earnings by Industry","22","Utilities"+",","Earnings",16021],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","72","Accommodation and Food Services"+",","Earnings",2096],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","71","Arts, Entertainment, and Recreation"+",","Earnings",2524],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","44-45","Retail Trade"+",","Earnings",2934],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","11","Agriculture, Forestry, Fishing and Hunting"+",","Earnings",3703],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","81","Other Services (except Public Administration)"+",","Earnings",3768],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","56","Administrative and Support and Waste Management and Remediation Services"+",","Earnings",3884],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","62","Health Care and Social Assistance"+",","Earnings",4526],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","48-49","Transportation and Warehousing"+",","Earnings",4565],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","92","Public Administration"+",","Earnings",5031],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","61","Educational Services"+",","Earnings",5189],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","53","Real Estate and Rental and Leasing"+",","Earnings",5317],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","23","Construction"+",","Earnings",5524],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","21","Mining, Quarrying, and Oil and Gas Extraction",,"Earnings",6266],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","31-33","Manufacturing"+",","Earnings",6512],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","42","Wholesale Trade"+",","Earnings",6615],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","51","Information"+",","Earnings",7132],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","55","Management of Companies and Enterprises"+",","Earnings",7604],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","52","Finance and Insurance"+",","Earnings",8267],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","54","Professional, Scientific, and Technical Services",,"Earnings",8338],
  ["Maryland","2019Q2","Maryland Average Monthly Earnings by Industry","22","Utilities"+",","Earnings",8729],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","11","Agriculture, Forestry, Fishing and Hunting"+",","Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","21","Mining, Quarrying, and Oil and Gas Extraction",,"Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","22","Utilities"+",","Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","23","Construction"+",","Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","42","Wholesale Trade"+",","Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","51","Information"+",","Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","52","Finance and Insurance"+",","Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","53","Real Estate and Rental and Leasing"+",","Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","54","Professional, Scientific, and Technical Services",,"Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","55","Management of Companies and Enterprises"+",","Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","56","Administrative and Support and Waste Management and Remediation Services"+",","Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","61","Educational Services"+",","Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","62","Health Care and Social Assistance"+",","Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","71","Arts, Entertainment, and Recreation"+",","Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","72","Accommodation and Food Services"+",","Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","81","Other Services (except Public Administration)"+",","Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","92","Public Administration"+",","Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","31-33","Manufacturing"+",","Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","44-45","Retail Trade"+",","Earnings","N/A"],
  ["Maryland","2019Q3","Maryland Average Monthly Earnings by Industry","48-49","Transportation and Warehousing"+",","Earnings","N/A"],
  ["Maryland","2016Q1","Maryland Job Net Change by Education","E1","Less than High school"+",","Job Change",1517],
  ["Maryland","2016Q1","Maryland Job Net Change by Education","E2","High school"+",","Job Change",1628],
  ["Maryland","2016Q1","Maryland Job Net Change by Education","E3","Some College"+",","Job Change",3532],
  ["Maryland","2016Q1","Maryland Job Net Change by Education","E4","Bachelor's or Higher"+",","Job Change",6911],
  ["Maryland","2016Q1","Maryland Job Net Change by Education","E5","N/A"+",","Job Change",10085],
  ["Maryland","2016Q2","Maryland Job Net Change by Education","E4","Bachelor's or Higher"+",","Job Change",999],
  ["Maryland","2016Q2","Maryland Job Net Change by Education","E3","Some College"+",","Job Change",4863],
  ["Maryland","2016Q2","Maryland Job Net Change by Education","E1","Less than High school"+",","Job Change",6152],
  ["Maryland","2016Q2","Maryland Job Net Change by Education","E2","High school"+",","Job Change",6551],
  ["Maryland","2016Q2","Maryland Job Net Change by Education","E5","N/A"+",","Job Change",60928],
  ["Maryland","2016Q3","Maryland Job Net Change by Education","E5","N/A"+",","Job Change",-16529],
  ["Maryland","2016Q3","Maryland Job Net Change by Education","E4","Bachelor's or Higher"+",","Job Change",-680],
  ["Maryland","2016Q3","Maryland Job Net Change by Education","E2","High school"+",","Job Change",-674],
  ["Maryland","2016Q3","Maryland Job Net Change by Education","E3","Some College"+",","Job Change",-410],
  ["Maryland","2016Q3","Maryland Job Net Change by Education","E1","Less than High school"+",","Job Change",741],
  ["Maryland","2016Q4","Maryland Job Net Change by Education","E2","High school"+",","Job Change",-3350],
  ["Maryland","2016Q4","Maryland Job Net Change by Education","E4","Bachelor's or Higher"+",","Job Change",-3042],
  ["Maryland","2016Q4","Maryland Job Net Change by Education","E3","Some College"+",","Job Change",-2765],
  ["Maryland","2016Q4","Maryland Job Net Change by Education","E1","Less than High school"+",","Job Change",-1893],
  ["Maryland","2016Q4","Maryland Job Net Change by Education","E5","N/A"+",","Job Change",9902],
  ["Maryland","2017Q1","Maryland Job Net Change by Education","E2","High school"+",","Job Change",-1146],
  ["Maryland","2017Q1","Maryland Job Net Change by Education","E3","Some College"+",","Job Change",-778],
  ["Maryland","2017Q1","Maryland Job Net Change by Education","E1","Less than High school"+",","Job Change",127],
  ["Maryland","2017Q1","Maryland Job Net Change by Education","E4","Bachelor's or Higher"+",","Job Change",1639],
  ["Maryland","2017Q1","Maryland Job Net Change by Education","E5","N/A"+",","Job Change",10185],
  ["Maryland","2017Q2","Maryland Job Net Change by Education","E4","Bachelor's or Higher"+",","Job Change",-2585],
  ["Maryland","2017Q2","Maryland Job Net Change by Education","E3","Some College"+",","Job Change",2009],
  ["Maryland","2017Q2","Maryland Job Net Change by Education","E2","High school"+",","Job Change",3807],
  ["Maryland","2017Q2","Maryland Job Net Change by Education","E1","Less than High school"+",","Job Change",4673],
  ["Maryland","2017Q2","Maryland Job Net Change by Education","E5","N/A"+",","Job Change",63237],
  ["Maryland","2017Q3","Maryland Job Net Change by Education","E5","N/A"+",","Job Change",-23907],
  ["Maryland","2017Q3","Maryland Job Net Change by Education","E3","Some College"+",","Job Change",-15],
  ["Maryland","2017Q3","Maryland Job Net Change by Education","E4","Bachelor's or Higher"+",","Job Change",-5],
  ["Maryland","2017Q3","Maryland Job Net Change by Education","E2","High school"+",","Job Change",37],
  ["Maryland","2017Q3","Maryland Job Net Change by Education","E1","Less than High school"+",","Job Change",1114],
  ["Maryland","2017Q4","Maryland Job Net Change by Education","E2","High school"+",","Job Change",-2750],
  ["Maryland","2017Q4","Maryland Job Net Change by Education","E3","Some College"+",","Job Change",-2404],
  ["Maryland","2017Q4","Maryland Job Net Change by Education","E1","Less than High school"+",","Job Change",-1981],
  ["Maryland","2017Q4","Maryland Job Net Change by Education","E4","Bachelor's or Higher"+",","Job Change",-1764],
  ["Maryland","2017Q4","Maryland Job Net Change by Education","E5","N/A"+",","Job Change",9993],
  ...
  ["Maryland","2018Q1","Maryland Net Change by Education","E0","High school or equivalent, no college",,"Job Change",-807],
  ["Maryland","2018Q1","Maryland Net Change by Education","E0","Some college or Associate degree"+",","Job Change",-324],
  ["Maryland","2018Q1","Maryland Net Change by Education","E0","Less than High school"+",","Job Change",232],
  ["Maryland","2018Q1","Maryland Net Change by Education","E1","Bachelor's degree or advanced degree"+",","Job Change",2050],
  ["Maryland","2018Q1","Maryland Net Change by Education","E1","Educational attainment not available (workers aged 24 or younger)"+",","Job Change",9392],
  ["Maryland","2018Q1","Maryland Net Change by Education","E0","All Education Categories"+",","Job Change",10517],
  ["Maryland","2018Q2","Maryland Net Change by Education","E2","Bachelor's degree or advanced degree"+",","Job Change",-2983],
  ["Maryland","2018Q2","Maryland Net Change by Education","E2","Some college or Associate degree"+",","Job Change",1350],
  ...
  ["Maryland","2018Q2","Maryland Net Change by Education","E2","Educational attainment not available (workers aged 24 or younger)"+",","Job Change",61370],
  ["Maryland","2018Q2","Maryland Net Change by Education","E1","All Education Categories"+",","Job Change",67966],
  ["Maryland","2018Q3","Maryland Net Change by Education","E4","Educational attainment not available (workers aged 24 or younger)"+",","Job Change",-22613],
  ["Maryland","2018Q3","Maryland Net Change by Education","E3","All Education Categories"+",","Job Change",-22197],
  ...
  ["Maryland","2018Q3","Maryland Net Change by Education","E3","High school or equivalent, no college",,"Job Change",8],
  ["Maryland","2018Q3","Maryland Net Change by Education","E3","Less than High school"+",","Job Change",1390],
  ["Maryland","2018Q4","Maryland Net Change by Education","E5","High school or equivalent, no college",,"Job Change",-3899],
  ["Maryland","2018Q4","Maryland Net Change by Education","E5","Some college or Associate degree"+",","Job Change",-3310],
  ["Maryland","2018Q4","Maryland Net Change by Education","E5","Bachelor's degree or advanced degree"+",","Job Change",-2201],
  ["Maryland","2018Q4","Maryland Net Change by Education","E4","Less than High school"+",","Job Change",-2065],
  ["Maryland","2018Q4","Maryland Net Change by Education","E4","All Education Categories"+",","Job Change",-1352],
  ...
  ["Maryland","2019Q1","Maryland Net Change by Education","E0","High school or equivalent, no college",,"Job Change",-1453],
  ["Maryland","2019Q1","Maryland Net Change by Education","E0","Some college or Associate degree"+",","Job Change",-628],
  ["Maryland","2019Q1","Maryland Net Change by Education","E0","Less than High school"+",","Job Change",240],
  ["Maryland","2019Q1","Maryland Net Change by Education","E1","Bachelor's degree or advanced degree"+",","Job Change",1350],
  ["Maryland","2019Q1","Maryland Net Change by Education","E0","All Education Categories"+",","Job Change",8805],
  ["Maryland","2019Q1","Maryland Net Change by Education","E1","Educational attainment not available (workers aged 24 or younger)"+",","Job Change",9323],
  ["Maryland","2019Q2","Maryland Net Change by Education","E2","Bachelor's degree or advanced degree"+",","Job Change",-740],
  ["Maryland","2019Q2","Maryland Net Change by Education","E2","Some college or Associate degree"+",","Job Change",3351],
  ...
  ["Maryland","2019Q2","Maryland Net Change by Education","E2","Educational attainment not available (workers aged 24 or younger)"+",","Job Change",61022],
  ["Maryland","2019Q2","Maryland Net Change by Education","E1","All Education Categories"+",","Job Change",74076],
  ["Maryland","2019Q3","Maryland Net Change by Education","E3","All Education Categories"+",","Job Change","N/A"],
  ["Maryland","2019Q3","Maryland Net Change by Education","E3","Less than High school"+",","Job Change","N/A"],
  ["Maryland","2019Q3","Maryland Net Change by Education","E3","High school or equivalent, no college",,"Job Change","N/A"],
  ...
  ["Maryland","2019Q3","Maryland Net Change by Education","E4","Educational attainment not available (workers aged 24 or younger)"+",","Job Change","N/A"],
  ...
  ["Maryland","2016Q1","Maryland New Hires by Education","E4","Bachelor's or Higher"+",","New Hires",60141],
  ["Maryland","2016Q1","Maryland New Hires by Education","E2","High school"+",","New Hires",65198],
  ["Maryland","2016Q1","Maryland New Hires by Education","E3","Some College"+",","New Hires",68855],
  ["Maryland","2016Q1","Maryland New Hires by Education","E5","N/A","New Hires",87757],
  ["Maryland","2016Q2","Maryland New Hires by Education","E1","Less than High school"+",","New Hires",54598],
  ["Maryland","2016Q2","Maryland New Hires by Education","E4","Bachelor's or Higher"+",","New Hires",68981],
  ["Maryland","2016Q2","Maryland New Hires by Education","E2","High school"+",","New Hires",83861],
  ["Maryland","2016Q2","Maryland New Hires by Education","E3","Some College"+",","New Hires",85218],
  ["Maryland","2016Q2","Maryland New Hires by Education","E5","N/A","New Hires",160115],
  ["Maryland","2016Q3","Maryland New Hires by Education","E1","Less than High school"+",","New Hires",53121],
  ["Maryland","2016Q3","Maryland New Hires by Education","E4","Bachelor's or Higher"+",","New Hires",70282],
  ["Maryland","2016Q3","Maryland New Hires by Education","E2","High school"+",","New Hires",82342],
  ["Maryland","2016Q3","Maryland New Hires by Education","E3","Some College"+",","New Hires",84948],
  ["Maryland","2016Q3","Maryland New Hires by Education","E5","N/A","New Hires",153228],
  ["Maryland","2016Q4","Maryland New Hires by Education","E1","Less than High school"+",","New Hires",52780],
  ["Maryland","2016Q4","Maryland New Hires by Education","E4","Bachelor's or Higher"+",","New Hires",71083],
  ["Maryland","2016Q4","Maryland New Hires by Education","E2","High school"+",","New Hires",82830],
  ["Maryland","2016Q4","Maryland New Hires by Education","E3","Some College"+",","New Hires",86278],
  ["Maryland","2016Q4","Maryland New Hires by Education","E5","N/A","New Hires",114818],
  ["Maryland","2017Q1","Maryland New Hires by Education","E1","Less than High school"+",","New Hires",42782],
  ["Maryland","2017Q1","Maryland New Hires by Education","E4","Bachelor's or Higher"+",","New Hires",59096],
  ["Maryland","2017Q1","Maryland New Hires by Education","E2","High school"+",","New Hires",66777],
  ["Maryland","2017Q1","Maryland New Hires by Education","E3","Some College"+",","New Hires",69629],
  ["Maryland","2017Q1","Maryland New Hires by Education","E5","N/A","New Hires",92389],
  ["Maryland","2017Q2","Maryland New Hires by Education","E1","Less than High school"+",","New Hires",54807],
  ["Maryland","2017Q2","Maryland New Hires by Education","E4","Bachelor's or Higher"+",","New Hires",67565],
  ["Maryland","2017Q2","Maryland New Hires by Education","E2","High school"+",","New Hires",83291],
  ["Maryland","2017Q2","Maryland New Hires by Education","E3","Some College"+",","New Hires",84775],
  ["Maryland","2017Q2","Maryland New Hires by Education","E5","N/A","New Hires",164531],
  ["Maryland","2017Q3","Maryland New Hires by Education","E1","Less than High school"+",","New Hires",52647],
  ["Maryland","2017Q3","Maryland New Hires by Education","E4","Bachelor's or Higher"+",","New Hires",68689],
  ["Maryland","2017Q3","Maryland New Hires by Education","E2","High school"+",","New Hires",80596],
  ["Maryland","2017Q3","Maryland New Hires by Education","E3","Some College"+",","New Hires",82917],
  ["Maryland","2017Q3","Maryland New Hires by Education","E5","N/A","New Hires",140788],
  ["Maryland","2017Q4","Maryland New Hires by Education","E1","Less than High school"+",","New Hires",52366],
  ["Maryland","2017Q4","Maryland New Hires by Education","E4","Bachelor's or Higher"+",","New Hires",72189],
  ["Maryland","2017Q4","Maryland New Hires by Education","E2","High school"+",","New Hires",81983],
  ["Maryland","2017Q4","Maryland New Hires by Education","E3","Some College"+",","New Hires",85599],
  ["Maryland","2017Q4","Maryland New Hires by Education","E5","N/A","New Hires",112289],
  ["Maryland","2018Q1","Maryland New Hires by Education","E0","Less than High school"+",","New Hires",42999],
  ["Maryland","2018Q1","Maryland New Hires by Education","E1","Bachelor's degree or advanced degree"+",","New Hires",60603],
  ["Maryland","2018Q1","Maryland New Hires by Education","E0","High school or equivalent, no college","New Hires",67174],
  ["Maryland","2018Q1","Maryland New Hires by Education","E0","Some college or Associate degree"+",","New Hires",70715],
  ["Maryland","2018Q1","Maryland New Hires by Education","E1","Educational attainment not available (workers aged 24 or younger)"+",","New Hires",90482],
  ...
  ["Maryland","2018Q2","Maryland New Hires by Education","E2","Bachelor's degree or advanced degree"+",","New Hires",69364],
  ["Maryland","2018Q2","Maryland New Hires by Education","E2","High school or equivalent, no college","New Hires",83720],
  ["Maryland","2018Q2","Maryland New Hires by Education","E2","Some college or Associate degree"+",","New Hires",85631],
  ["Maryland","2018Q2","Maryland New Hires by Education","E2","Educational attainment not available (workers aged 24 or younger)"+",","New Hires",160190],
  ["Maryland","2018Q2","Maryland New Hires by Education","E1","All Education Categories"+",","New Hires",453492],
  ["Maryland","2018Q3","Maryland New Hires by Education","E3","Less than High school"+",","New Hires",53408],
  ["Maryland","2018Q3","Maryland New Hires by Education","E4","Bachelor's degree or advanced degree"+",","New Hires",70180],
  ["Maryland","2018Q3","Maryland New Hires by Education","E3","High school or equivalent, no college","New Hires",81838],
  ["Maryland","2018Q3","Maryland New Hires by Education","E3","Some college or Associate degree"+",","New Hires",85281],
  ["Maryland","2018Q3","Maryland New Hires by Education","E4","Educational attainment not available (workers aged 24 or younger)"+",","New Hires",142197],
  ["Maryland","2018Q3","Maryland New Hires by Education","E3","All Education Categories"+",","New Hires",432904],
  ["Maryland","2018Q4","Maryland New Hires by Education","E4","Less than High school"+",","New Hires",53570],
  ["Maryland","2018Q4","Maryland New Hires by Education","E5","Bachelor's degree or advanced degree"+",","New Hires",75530],
  ["Maryland","2018Q4","Maryland New Hires by Education","E5","High school or equivalent, no college","New Hires",84122],
  ["Maryland","2018Q4","Maryland New Hires by Education","E5","Some college or Associate degree"+",","New Hires",89208],
  ...
  ["Maryland","2018Q4","Maryland New Hires by Education","E4","All Education Categories"+",","New Hires",413543],
  ["Maryland","2019Q1","Maryland New Hires by Education","E0","Less than High school"+",","New Hires",42318],
  ["Maryland","2019Q1","Maryland New Hires by Education","E1","Bachelor's degree or advanced degree"+",","New Hires",59778],
  ["Maryland","2019Q1","Maryland New Hires by Education","E0","High school or equivalent, no college","New Hires",65782],
  ["Maryland","2019Q1","Maryland New Hires by Education","E0","Some college or Associate degree"+",","New Hires",69697],
  ["Maryland","2019Q1","Maryland New Hires by Education","E1","Educational attainment not available (workers aged 24 or younger)"+",","New Hires",88724],
  ...
  ["Maryland","2019Q2","Maryland New Hires by Education","E2","Bachelor's degree or advanced degree"+",","New Hires",73827],
  ["Maryland","2019Q2","Maryland New Hires by Education","E2","High school or equivalent, no college","New Hires",87105],
  ["Maryland","2019Q2","Maryland New Hires by Education","E2","Some college or Associate degree"+",","New Hires",90289],
  ["Maryland","2019Q2","Maryland New Hires by Education","E2","Educational attainment not available (workers aged 24 or younger)"+",","New Hires",162334],
  ["Maryland","2019Q2","Maryland New Hires by Education","E1","All Education Categories"+",","New Hires",470303],
  ["Maryland","2019Q3","Maryland New Hires by Education","E3","Less than High school"+",","New Hires",53104],
  ["Maryland","2019Q3","Maryland New Hires by Education","E4","Bachelor's degree or advanced degree"+",","New Hires",71452],
  ["Maryland","2019Q3","Maryland New Hires by Education","E3","High school or equivalent, no college","New Hires",82729],
  ["Maryland","2019Q3","Maryland New Hires by Education","E3","Some college or Associate degree"+",","New Hires",86864],
  ["Maryland","2019Q3","Maryland New Hires by Education","E4","Educational attainment not available (workers aged 24 or younger)"+",","New Hires",144228],
  ["Maryland","2019Q3","Maryland New Hires by Education","E3","All Education Categories"+",","New Hires",438377],
  ...
  ["Maryland","2016Q1","Maryland Separations by Education","E1","Less than High school"+",","Seperation",39694],
  ["Maryland","2016Q1","Maryland Separations by Education","E4","Bachelor's or Higher"+",","Seperation",53627],
  ["Maryland","2016Q1","Maryland Separations by Education","E4","Bachelor's or Higher"+",","Seperation",53627],
  ["Maryland","2016Q1","Maryland Separations by Education","E2","High school"+",","Seperation",63867],
  ["Maryland","2016Q1","Maryland Separations by Education","E2","High school"+",","Seperation",63867],
  ["Maryland","2016Q1","Maryland Separations by Education","E3","Some College"+",","Seperation",65752],
  ["Maryland","2016Q1","Maryland Separations by Education","E3","Some College"+",","Seperation",65752],
  ["Maryland","2016Q1","Maryland Separations by Education","E5","N/A"+",","Seperation",77963],
  ["Maryland","2016Q1","Maryland Separations by Education","E5","N/A"+",","Seperation",77963],
  ["Maryland","2016Q2","Maryland Separations by Education","E1","Less than High school"+",","Seperation",48304],
  ["Maryland","2016Q2","Maryland Separations by Education","E1","Less than High school"+",","Seperation",48304],
  ["Maryland","2016Q2","Maryland Separations by Education","E4","Bachelor's or Higher"+",","Seperation",67735],
  ["Maryland","2016Q2","Maryland Separations by Education","E4","Bachelor's or Higher"+",","Seperation",67735],
  ["Maryland","2016Q2","Maryland Separations by Education","E2","High school"+",","Seperation",77054],
  ["Maryland","2016Q2","Maryland Separations by Education","E2","High school"+",","Seperation",77054],
  ["Maryland","2016Q2","Maryland Separations by Education","E3","Some College"+",","Seperation",80074],
  ["Maryland","2016Q2","Maryland Separations by Education","E3","Some College"+",","Seperation",80074],
  ["Maryland","2016Q2","Maryland Separations by Education","E5","N/A"+",","Seperation",99193],
  ["Maryland","2016Q2","Maryland Separations by Education","E5","N/A"+",","Seperation",99193],
  ["Maryland","2016Q3","Maryland Separations by Education","E1","Less than High school"+",","Seperation",52337],
  ["Maryland","2016Q3","Maryland Separations by Education","E1","Less than High school"+",","Seperation",52337],
  ["Maryland","2016Q3","Maryland Separations by Education","E4","Bachelor's or Higher"+",","Seperation",70882],
  ["Maryland","2016Q3","Maryland Separations by Education","E4","Bachelor's or Higher"+",","Seperation",70882],
  ["Maryland","2016Q3","Maryland Separations by Education","E2","High school"+",","Seperation",82915],
  ["Maryland","2016Q3","Maryland Separations by Education","E2","High school"+",","Seperation",82915],
  ["Maryland","2016Q3","Maryland Separations by Education","E3","Some College"+",","Seperation",85204],
  ["Maryland","2016Q3","Maryland Separations by Education","E3","Some College"+",","Seperation",85204],
  ["Maryland","2016Q3","Maryland Separations by Education","E5","N/A"+",","Seperation",169749],
  ["Maryland","2016Q3","Maryland Separations by Education","E5","N/A"+",","Seperation",169749],
  ["Maryland","2016Q4","Maryland Separations by Education","E1","Less than High school"+",","Seperation",54521],
  ["Maryland","2016Q4","Maryland Separations by Education","E1","Less than High school"+",","Seperation",54521],
  ["Maryland","2016Q4","Maryland Separations by Education","E4","Bachelor's or Higher"+",","Seperation",74003],
  ["Maryland","2016Q4","Maryland Separations by Education","E4","Bachelor's or Higher"+",","Seperation",74003],
  ["Maryland","2016Q4","Maryland Separations by Education","E2","High school"+",","Seperation",85952],
  ["Maryland","2016Q4","Maryland Separations by Education","E2","High school"+",","Seperation",85952],
  ["Maryland","2016Q4","Maryland Separations by Education","E3","Some College"+",","Seperation",88821],
  ["Maryland","2016Q4","Maryland Separations by Education","E3","Some College"+",","Seperation",88821],
  ["Maryland","2016Q4","Maryland Separations by Education","E5","N/A"+",","Seperation",104671],
  ["Maryland","2016Q4","Maryland Separations by Education","E5","N/A"+",","Seperation",104671],
  ["Maryland","2017Q1","Maryland Separations by Education","E1","Less than High school"+",","Seperation",42714],
  ["Maryland","2017Q1","Maryland Separations by Education","E4","Bachelor's or Higher"+",","Seperation",57409],
  ["Maryland","2017Q1","Maryland Separations by Education","E2","High school"+",","Seperation",68006],
  ["Maryland","2017Q1","Maryland Separations by Education","E3","Some College"+",","Seperation",70452],
  ["Maryland","2017Q1","Maryland Separations by Education","E5","N/A"+",","Seperation",82365],
  ["Maryland","2017Q2","Maryland Separations by Education","E1","Less than High school"+",","Seperation",50068],
  ["Maryland","2017Q2","Maryland Separations by Education","E4","Bachelor's or Higher"+",","Seperation",70245],
  ["Maryland","2017Q2","Maryland Separations by Education","E2","High school"+",","Seperation",79472],
  ["Maryland","2017Q2","Maryland Separations by Education","E3","Some College"+",","Seperation",82731],
  ["Maryland","2017Q2","Maryland Separations by Education","E5","N/A"+",","Seperation",101505],
  ["Maryland","2017Q3","Maryland Separations by Education","E1","Less than High school"+",","Seperation",51436],
  ["Maryland","2017Q3","Maryland Separations by Education","E4","Bachelor's or Higher"+",","Seperation",68467],
  ["Maryland","2017Q3","Maryland Separations by Education","E2","High school"+",","Seperation",80356],
  ["Maryland","2017Q3","Maryland Separations by Education","E3","Some College"+",","Seperation",82726],
  ["Maryland","2017Q3","Maryland Separations by Education","E5","N/A"+",","Seperation",164513],
  ["Maryland","2017Q4","Maryland Separations by Education","E1","Less than High school"+",","Seperation",54336],
  ["Maryland","2017Q4","Maryland Separations by Education","E4","Bachelor's or Higher"+",","Seperation",73816],
  ["Maryland","2017Q4","Maryland Separations by Education","E2","High school"+",","Seperation",84687],
  ["Maryland","2017Q4","Maryland Separations by Education","E3","Some College"+",","Seperation",87930],
  ["Maryland","2017Q4","Maryland Separations by Education","E5","N/A"+",","Seperation",102206],
  ["Maryland","2018Q1","Maryland Separations by Education","E0","Less than High school"+",","Seperation",42803],
  ["Maryland","2018Q1","Maryland Separations by Education","E1","Less than High school"+",","Seperation",42909],
  ["Maryland","2018Q1","Maryland Separations by Education","E4","Bachelor's or Higher"+",","Seperation",58322],
  ["Maryland","2018Q1","Maryland Separations by Education","E1","Bachelor's degree or advanced degree"+",","Seperation",58600],
  ["Maryland","2018Q1","Maryland Separations by Education","E0","High school or equivalent, no college",,"Seperation",68061],
  ["Maryland","2018Q1","Maryland Separations by Education","E2","High school"+",","Seperation",68116],
  ["Maryland","2018Q1","Maryland Separations by Education","E3","Some College"+",","Seperation",70944],
  ["Maryland","2018Q1","Maryland Separations by Education","E0","Some college or Associate degree"+",","Seperation",71112],
  ["Maryland","2018Q1","Maryland Separations by Education","E1","Educational attainment not available (workers aged 24 or younger)"+",","Seperation",81276],
  ["Maryland","2018Q1","Maryland Separations by Education","E5","N/A"+",","Seperation",81337],
  ...
  ["Maryland","2018Q2","Maryland Separations by Education","E2","Bachelor's degree or advanced degree"+",","Seperation",72368],
  ["Maryland","2018Q2","Maryland Separations by Education","E2","High school or equivalent, no college",,"Seperation",80054],
  ["Maryland","2018Q2","Maryland Separations by Education","E2","Some college or Associate degree"+",","Seperation",84279],
  ["Maryland","2018Q2","Maryland Separations by Education","E2","Educational attainment not available (workers aged 24 or younger)"+",","Seperation",98957],
  ["Maryland","2018Q2","Maryland Separations by Education","E1","All Education Categories"+",","Seperation",385558],
  ["Maryland","2018Q3","Maryland Separations by Education","E3","Less than High school"+",","Seperation",51928],
  ["Maryland","2018Q3","Maryland Separations by Education","E4","Bachelor's degree or advanced degree"+",","Seperation",71007],
  ["Maryland","2018Q3","Maryland Separations by Education","E3","High school or equivalent, no college",,"Seperation",81710],
  ["Maryland","2018Q3","Maryland Separations by Education","E3","Some college or Associate degree"+",","Seperation",85243],
  ["Maryland","2018Q3","Maryland Separations by Education","E4","Educational attainment not available (workers aged 24 or younger)"+",","Seperation",164567],
  ["Maryland","2018Q3","Maryland Separations by Education","E3","All Education Categories"+",","Seperation",454455],
  ["Maryland","2018Q4","Maryland Separations by Education","E4","Less than High school"+",","Seperation",55490],
  ["Maryland","2018Q4","Maryland Separations by Education","E5","Bachelor's degree or advanced degree"+",","Seperation",77597],
  ["Maryland","2018Q4","Maryland Separations by Education","E5","High school or equivalent, no college",,"Seperation",87777],
  ["Maryland","2018Q4","Maryland Separations by Education","E5","Some college or Associate degree"+",","Seperation",92248],
  ...
  ["Maryland","2018Q4","Maryland Separations by Education","E4","All Education Categories"+",","Seperation",413983],
  ["Maryland","2019Q1","Maryland Separations by Education","E0","Less than High school"+",","Seperation",42194],
  ["Maryland","2019Q1","Maryland Separations by Education","E1","Bachelor's degree or advanced degree"+",","Seperation",58498],
  ["Maryland","2019Q1","Maryland Separations by Education","E0","High school or equivalent, no college",,"Seperation",67476],
  ["Maryland","2019Q1","Maryland Separations by Education","E0","Some college or Associate degree"+",","Seperation",70506],
  ["Maryland","2019Q1","Maryland Separations by Education","E1","Educational attainment not available (workers aged 24 or younger)"+",","Seperation",79775],
  ...
  ["Maryland","2019Q2","Maryland Separations by Education","E2","Bachelor's degree or advanced degree"+",","Seperation",74515],
  ["Maryland","2019Q2","Maryland Separations by Education","E2","High school or equivalent, no college",,"Seperation",82014],
  ["Maryland","2019Q2","Maryland Separations by Education","E2","Some college or Associate degree"+",","Seperation",86910],
  ["Maryland","2019Q2","Maryland Separations by Education","E2","Educational attainment not available (workers aged 24 or younger)"+",","Seperation",101570],
  ["Maryland","2019Q2","Maryland Separations by Education","E1","All Education Categories"+",","Seperation",396355],
  ["Maryland","2019Q3","Maryland Separations by Education","E3","All Education Categories"+",","Seperation","N/A"],
  ["Maryland","2019Q3","Maryland Separations by Education","E3","Less than High school"+",","Seperation","N/A"],
  ["Maryland","2019Q3","Maryland Separations by Education","E3","High school or equivalent, no college",,"Seperation","N/A"],
  ...
  ["Maryland","2019Q3","Maryland Separations by Education","E4","Educational attainment not available (workers aged 24 or younger)"+",","Seperation","N/A"],
  ...
  ["Maryland","2016Q1","Maryland Turnover Rate by Education","E4","Bachelor's or Higher"+",","Turnover",0.064],
  ["Maryland","2016Q1","Maryland Turnover Rate by Education","E3","Some College"+",","Turnover",0.075],
  ["Maryland","2016Q1","Maryland Turnover Rate by Education","E2","High school"+",","Turnover",0.08],
  ["Maryland","2016Q1","Maryland Turnover Rate by Education","E1","Less than High school"+",","Turnover",0.094],
  ["Maryland","2016Q1","Maryland Turnover Rate by Education","E5","N/A"+",","Turnover",0.196],
  ["Maryland","2016Q2","Maryland Turnover Rate by Education","E4","Bachelor's or Higher"+",","Turnover",0.062],
  ["Maryland","2016Q2","Maryland Turnover Rate by Education","E3","Some College"+",","Turnover",0.071],
  ["Maryland","2016Q2","Maryland Turnover Rate by Education","E2","High school"+",","Turnover",0.075],
  ["Maryland","2016Q2","Maryland Turnover Rate by Education","E1","Less than High school"+",","Turnover",0.09],
  ["Maryland","2016Q2","Maryland Turnover Rate by Education","E5","N/A"+",","Turnover",0.203],
  ["Maryland","2016Q3","Maryland Turnover Rate by Education","E4","Bachelor's or Higher"+",","Turnover",0.064],
  ["Maryland","2016Q3","Maryland Turnover Rate by Education","E3","Some College"+",","Turnover",0.076],
  ["Maryland","2016Q3","Maryland Turnover Rate by Education","E2","High school"+",","Turnover",0.082],
  ["Maryland","2016Q3","Maryland Turnover Rate by Education","E1","Less than High school"+",","Turnover",0.101],
  ["Maryland","2016Q3","Maryland Turnover Rate by Education","E5","N/A"+",","Turnover",0.217],
  ["Maryland","2016Q4","Maryland Turnover Rate by Education","E4","Bachelor's or Higher"+",","Turnover",0.061],
  ["Maryland","2016Q4","Maryland Turnover Rate by Education","E3","Some College"+",","Turnover",0.072],
  ["Maryland","2016Q4","Maryland Turnover Rate by Education","E2","High school"+",","Turnover",0.077],
  ["Maryland","2016Q4","Maryland Turnover Rate by Education","E1","Less than High school"+",","Turnover",0.092],
  ["Maryland","2016Q4","Maryland Turnover Rate by Education","E5","N/A"+",","Turnover",0.208],
  ["Maryland","2017Q1","Maryland Turnover Rate by Education","E4","Bachelor's or Higher"+",","Turnover",0.064],
  ["Maryland","2017Q1","Maryland Turnover Rate by Education","E3","Some College"+",","Turnover",0.074],
  ["Maryland","2017Q1","Maryland Turnover Rate by Education","E2","High school"+",","Turnover",0.078],
  ["Maryland","2017Q1","Maryland Turnover Rate by Education","E1","Less than High school"+",","Turnover",0.092],
  ["Maryland","2017Q1","Maryland Turnover Rate by Education","E5","N/A"+",","Turnover",0.194],
  ["Maryland","2017Q2","Maryland Turnover Rate by Education","E4","Bachelor's or Higher"+",","Turnover",0.061],
  ["Maryland","2017Q2","Maryland Turnover Rate by Education","E3","Some College"+",","Turnover",0.069],
  ["Maryland","2017Q2","Maryland Turnover Rate by Education","E2","High school"+",","Turnover",0.074],
  ["Maryland","2017Q2","Maryland Turnover Rate by Education","E1","Less than High school"+",","Turnover",0.088],
  ["Maryland","2017Q2","Maryland Turnover Rate by Education","E5","N/A"+",","Turnover",0.206],
  ["Maryland","2017Q3","Maryland Turnover Rate by Education","E4","Bachelor's or Higher"+",","Turnover",0.063],
  ["Maryland","2017Q3","Maryland Turnover Rate by Education","E3","Some College"+",","Turnover",0.076],
  ["Maryland","2017Q3","Maryland Turnover Rate by Education","E2","High school"+",","Turnover",0.081],
  ["Maryland","2017Q3","Maryland Turnover Rate by Education","E1","Less than High school"+",","Turnover",0.099],
  ["Maryland","2017Q3","Maryland Turnover Rate by Education","E5","N/A"+",","Turnover",0.217],
  ["Maryland","2017Q4","Maryland Turnover Rate by Education","E4","Bachelor's or Higher"+",","Turnover",0.061],
  ["Maryland","2017Q4","Maryland Turnover Rate by Education","E3","Some College"+",","Turnover",0.071],
  ["Maryland","2017Q4","Maryland Turnover Rate by Education","E2","High school"+",","Turnover",0.076],
  ["Maryland","2017Q4","Maryland Turnover Rate by Education","E1","Less than High school"+",","Turnover",0.089],
  ["Maryland","2017Q4","Maryland Turnover Rate by Education","E5","N/A"+",","Turnover",0.202],
  ["Maryland","2018Q1","Maryland Turnover Rate by Education","E1","Bachelor's or Higher"+",","Turnover Rate",0.065],
  ["Maryland","2018Q1","Maryland Turnover Rate by Education","E0","Some College"+",","Turnover Rate",0.074],
  ["Maryland","2018Q1","Maryland Turnover Rate by Education","E0","High school"+",","Turnover Rate",0.078],
  ["Maryland","2018Q1","Maryland Turnover Rate by Education","E0","All Education Categories"+",","Turnover Rate",0.086],
  ["Maryland","2018Q1","Maryland Turnover Rate by Education","E0","Less than High school"+",","Turnover Rate",0.09],
  ["Maryland","2018Q1","Maryland Turnover Rate by Education","E1","N/A"+",","Turnover Rate",0.191],
  ["Maryland","2018Q2","Maryland Turnover Rate by Education","E2","Bachelor's or Higher"+",","Turnover Rate",0.061],
  ["Maryland","2018Q2","Maryland Turnover Rate by Education","E2","Some College"+",","Turnover Rate",0.07],
  ["Maryland","2018Q2","Maryland Turnover Rate by Education","E2","High school"+",","Turnover Rate",0.074],
  ["Maryland","2018Q2","Maryland Turnover Rate by Education","E1","All Education Categories"+",","Turnover Rate",0.084],
  ["Maryland","2018Q2","Maryland Turnover Rate by Education","E1","Less than High school"+",","Turnover Rate",0.087],
  ["Maryland","2018Q2","Maryland Turnover Rate by Education","E2","N/A",","+"Turnover Rate",0.202],
  ["Maryland","2018Q3","Maryland Turnover Rate by Education","E4","Bachelor's or Higher"+",","Turnover Rate",0.065],
  ["Maryland","2018Q3","Maryland Turnover Rate by Education","E3","Some College"+",","Turnover Rate",0.077],
  ["Maryland","2018Q3","Maryland Turnover Rate by Education","E3","High school"+",","Turnover Rate",0.082],
  ["Maryland","2018Q3","Maryland Turnover Rate by Education","E3","All Education Categories"+",","Turnover Rate",0.091],
  ["Maryland","2018Q3","Maryland Turnover Rate by Education","E3","Less than High school"+",","Turnover Rate",0.098],
  ["Maryland","2018Q3","Maryland Turnover Rate by Education","E4","N/A",","+"Turnover Rate",0.215],
  ["Maryland","2018Q4","Maryland Turnover Rate by Education","E5","Bachelor's or Higher"+",","Turnover Rate",0.06],
  ["Maryland","2018Q4","Maryland Turnover Rate by Education","E5","Some College"+",","Turnover Rate",0.07],
  ["Maryland","2018Q4","Maryland Turnover Rate by Education","E5","High school"+",","Turnover Rate",0.075],
  ["Maryland","2018Q4","Maryland Turnover Rate by Education","E4","All Education Categories"+",","Turnover Rate",0.084],
  ["Maryland","2018Q4","Maryland Turnover Rate by Education","E4","Less than High school"+",","Turnover Rate",0.088],
  ["Maryland","2018Q4","Maryland Turnover Rate by Education","E5","N/A",","+"Turnover Rate",0.198],
  ["Maryland","2019Q1","Maryland Turnover Rate by Education","E1","Bachelor's or Higher"+",","Turnover Rate",0.067],
  ["Maryland","2019Q1","Maryland Turnover Rate by Education","E0","Some College"+",","Turnover Rate",0.076],
  ["Maryland","2019Q1","Maryland Turnover Rate by Education","E0","High school"+",","Turnover Rate",0.08],
  ["Maryland","2019Q1","Maryland Turnover Rate by Education","E0","All Education Categories"+",","Turnover Rate",0.088],
  ["Maryland","2019Q1","Maryland Turnover Rate by Education","E0","Less than High school"+",","Turnover Rate",0.092],
  ["Maryland","2019Q1","Maryland Turnover Rate by Education","E1","N/A",","+"Turnover Rate",0.194],
  ["Maryland","2019Q2","Maryland Turnover Rate by Education","E1","All Education Categories"+",","Turnover Rate","N/A"],
  ["Maryland","2019Q2","Maryland Turnover Rate by Education","E1","Less than High school"+",","Turnover Rate","N/A"],
  ["Maryland","2019Q2","Maryland Turnover Rate by Education","E2","High school"+",","Turnover Rate","N/A"],
  ["Maryland","2019Q2","Maryland Turnover Rate by Education","E2","Some College"+",","Turnover Rate","N/A"],
  ["Maryland","2019Q2","Maryland Turnover Rate by Education","E2","Bachelor's or Higher"+",","Turnover Rate","N/A"],
  ["Maryland","2019Q2","Maryland Turnover Rate by Education","E2","N/A",","+"Turnover Rate","N/A"],
  ["Maryland","2019Q3","Maryland Turnover Rate by Education","E3","All Education Categories"+",","Turnover Rate","N/A"],
  ["Maryland","2019Q3","Maryland Turnover Rate by Education","E3","Less than High school"+",","Turnover Rate","N/A"],
  ["Maryland","2019Q3","Maryland Turnover Rate by Education","E3","High school"+",","Turnover Rate","N/A"],
  ["Maryland","2019Q3","Maryland Turnover Rate by Education","E3","Some College"+",","Turnover Rate","N/A"],
  ["Maryland","2019Q3","Maryland Turnover Rate by Education","E4","Bachelor's or Higher"+",","Turnover Rate","N/A"],
  ["Maryland","2019Q3","Maryland Turnover Rate by Education","E4","N/A",","+"Turnover Rate","N/A"],
  ...
  ["Maryland","2018Q3","Maryland Workers by Industry","61","Educational Services"+",","Workers",232929],
  ...
  ["Maryland","2018Q4","Maryland Workers by Industry","11","Agriculture, Forestry, Fishing and Hunting"+",","Workers",5599],
