    ...
    .then((data) => {
      ...
      var Objectarray = {
        ...
        Maryland: {
          ...
          set41: {
            url41:
              "https://api.census.gov/data/timeseries/qwi/sa?get=HirN&for=workforce+investment+area:001004&in=state:24&time=" +
              year +
              "-" +
              "Q1" +
              "&industry=72&key=855666deab62d95596011f1944d9f1bd8c918853",
            arrayformat41: [
              "New Hires,Frederick WIA",
          ...
          set72: {
            ...
            arrayformat72: [
              "Turnover,Frederick WIA","Maryland Turnover Rate by Education",
              year + "Q4",
              "E5",
          ...
          set638: {
            url638:
              "https://api.census.gov/data/timeseries/qwi/se?get=HirN&for=workforce+investment+area:001004&in=state:24&time=" +
              year +
              "-" +
              "Q1" +
              "&education=E1&key=855666deab62d95596011f1944d9f1bd8c918853",
          ...
          set701: {
            ...
            arrayformat701: [
              ...
              "&education=E0&key=855666deab62d95596011f1944d9f1bd8c918853",
              arrayformat778: [
              "Turnover,Frederick WIA","Maryland Turnover Rate by Education All",
              year + "Q1",
              "E0",
              "All Education Categories",
              dataend,
